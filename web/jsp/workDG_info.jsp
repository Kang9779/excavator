        ...
        <div class="container-fluid">
            <div class="nav-tabs-custom col-md-6">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/page?method=workDGInfo" >斗杆信息</a></li>
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $.each(result,function (index) {
                    ...
                    dataY1.push(result[index].dgyp);
                    dataY2.push(result[index].dgwp);
                    dataY3.push(result[index].dgwy);
                    dataX_angle.push(result[index].dgX);
                    dataY_angle.push(result[index].dgY);
                });
