        ...
        <div class="container-fluid">
            <div class="nav-tabs-custom col-md-6">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/page?method=workCDInfo" data-toggle="tab">铲斗信息</a></li>
                </ul>
            </div>
        </div>
        <%--铲斗传感器信息--%>
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $.each(result,function (index) {
                    ...
                    dataY1.push(result[index].cdyp);
                    dataY2.push(result[index].cdwp);
                    dataY3.push(result[index].cdwy);
                    dataX_angle.push(result[index].cdX);
                    dataY_angle.push(result[index].cdY);
                });
